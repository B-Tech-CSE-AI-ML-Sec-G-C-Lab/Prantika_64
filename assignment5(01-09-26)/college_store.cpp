/* A college stores marks of students as private data. The examination
 department wants to compare the marks of two students and identify 
 the student with the higher score. Use friend function in C++ to 
